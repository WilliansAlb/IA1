...
def main():
    ...
    pippu_img = tk.PhotoImage(file="./imgs/Pippu.png")
    porp_image = tk.PhotoImage(file="./imgs/Porp.png")
    cabro_image = tk.PhotoImage(file="./imgs/Cabro.png")
    ...
    # Create a clickable area as a button
    ...
    # Run the application
    root.mainloop()
    # Stop the click handler thread when the window is closed
    vending.stop()
    vending.join()
